...
m1 <- drm(biomass~dose, population, data=pam, fct=LL.4(ss="3"))
summary(m1)
plot(m1)
...
m2 <- drm(biomass~dose, population, data=pam, fct=LL.4(ss="3"), pmodels=data.frame(1,1,1,population))
summary(m2)
plot(m2)
...
m3 <- drm(biomass~dose, population, data=pam, fct=LL.4(ss="3"), pmodels=data.frame(1,1,1,1))
summary(m3)
plot(m3)
